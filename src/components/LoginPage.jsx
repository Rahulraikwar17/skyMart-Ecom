...
const LoginPage = () => {
  ...
  return (
    <div className="min-h-screen w-full lg:w-[40%] bg-[#1F0F0C] flex items-center justify-center px-5">
      <div className="w-full max-w-md lg:max-w-none rounded-3xl border border-[#C1443A]/30 bg-[#2A1712] shadow-2xl p-6 sm:p-10">
        <h1 className="text-3xl sm:text-5xl font-bold text-white">Sign in</h1>

        <p className="text-[#FFA98F]/60 mt-3 text-lg">
          Enter your credentials to continue
        </p>

        <form onSubmit={handleSubmit(formSubmit)} className="mt-6 sm:mt-10 space-y-5 sm:space-y-6">

...
const RegisterPage = () => {
  ...
  return (
    <div className="min-h-screen w-full lg:w-[40%] bg-[#1F0F0C] flex items-center justify-center px-5 py-10 overflow-hidden relative">
      <div className="relative w-full h-full max-w-xl rounded-3xl border border-[#C1443A]/30 bg-[#2A1712]/90 backdrop-blur-xl p-5 sm:p-8 shadow-[0_0_60px_rgba(0,0,0,.45)]">
        <h1 className="text-3xl sm:text-5xl font-bold text-white">Create account</h1>

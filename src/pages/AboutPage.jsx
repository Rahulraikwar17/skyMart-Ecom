    ...
    <div className="w-full bg-[#1F0F0C]">
      ...
      <div className="max-w-5xl mx-auto px-6 py-20">
        <div className="flex flex-col items-center text-center">
          ...
          <p className="text-[#FFA98F]/70 text-lg mt-4 max-w-2xl">
        ...
        <div className="rounded-3xl border border-[#C1443A]/30 max-[376px]:p-3 p-10 mt-14">
        ...
        <div className="rounded-3xl border border-[#F87060]/40 p-14 mt-16 flex flex-col items-center text-center">
